...
```bash
launchctl load ~/Library/LaunchAgents/com.mydownloader.service.plist
launchctl start com.mydownloader.service
```
...
```bash
launchctl unload ~/Library/LaunchAgents/com.mydownloader.service.plist
```
